...
from datasets.base_spuco_dataset import TRAIN_SPLIT, BaseSpuCoDataset, SourceData
from datasets.spuco_birds import SpuCoBirds
from datasets.spuco_dogs import SpuCoDogs
